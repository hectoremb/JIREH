  ...
  <body>
    ...
    <h3>Datos del Cliente</h3>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
          <tr>
            <td class="unit"  width="30%;">MUESTRA</th>
            <td class="desc" colspan="2" >{{ $muestra }}</th>
            
          </tr>
          <tr>
            <td class="unit"   width="30%;">PRUEBA</th>
            <td class="desc" colspan="2" >TOXOPLASMA GONDII IgM - IgG</th>
        ...
        <tbody id="invoiceItems">
         ...
         <tr>
            <td class="desc" colspan="3" style="border-bottom: 0px;"></td>
          </tr>

        <thead >
          <tr>
            <th style="background: #98E8E8;"><strong>PRUEBA</strong></th>
            <th style="background: #98E8E8;"><strong>RESULTADO</strong></th>
            <th  style="background: #98E8E8;"colspan="1"><strong>VALORES NORMALES</strong></th>
          ...
          <tr>
            <td class="unit" >TOXOPLASMA GONDII IgM</td>
            <td class="desc" colspan="1">{{ $igm }} </td>
            <td class="unit" colspan="1">{{ $valoresigm }}</td>
          </tr>

          <tr>
            <td class="unit" >TOXOPLASMA GONDII IgG</td>
            <td class="desc" colspan="1">{{ $igg }} </td>
            <td class="unit" colspan="1">{{ $valoresigg }}</td>
          </tr>
