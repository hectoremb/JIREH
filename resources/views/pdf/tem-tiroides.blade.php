      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
          ...
          <tr>
            ...
            <td class="desc" colspan="2" >TIROIDES</th>
        ...
        <thead >
          ...
          <tr>
            <td class="unit" >T3</td>
            <td class="desc" colspan="1">{{ $t3 }} </td>
            <td class="unit" colspan="1">{{ $vat3 }}</td>
          </tr>

          <tr>
            <td class="unit" >T4</td>
            <td class="desc" colspan="1">{{ $t4 }} </td>
            <td class="unit" colspan="1">{{ $vat4 }}</td>
          </tr>

          <tr>
            <td class="unit" >TSH</td>
            <td class="desc" colspan="1">{{ $tsh }} </td>
            <td class="unit" colspan="1">{{ $vatsh }}</td>
          </tr>
