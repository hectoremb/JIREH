  ...
  <body>
    ...
    <h3>Datos del Cliente</h3>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
          <tr>
            <td class="unit"  width="30%;">MUESTRA</td>
            <td class="desc" colspan="1" >{{ $muestra }}</td>
            
          </tr>
          <tr>
            <td class="unit"   width="30%;">PRUEBA</td>
            <td class="desc" colspan="1" >ANTIGENO PROSTATICO ESPECIFICO (PSA)</td>
        ...
        <tbody id="invoiceItems">
         ...
         <tr>
            <td class="desc" colspan="2" style="border-bottom: 0px;"></td>
          </tr>
        ...
        <thead >
          ...
          <tr>
            <td class="desc" colspan="1">{{ $res }} </td>
            <td class="unit" colspan="1">{{ $valores }}</td>
          </tr>


          
          <tr>
            <td class="desc"  colspan="2" >Observaciones: {{ $Observacion }}
            </td>
          </tr>
        </tbody>
