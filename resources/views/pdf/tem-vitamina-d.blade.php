    ...
    <h3>Datos del Cliente</h3>
      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
          ...
          <tr>
            <td class="unit"   width="35%;">PRUEBA</th>
            <td class="desc" colspan="2" >VITAMINA D</th>
        ...
        <thead >
          <tr>
            ...
            <th  style="background: #98E8E8;"colspan="2"><strong>VALORES NORMALES</strong></th>
          ...
          <tr>
            <td class="unit" >{{ $res }} </td>
            <td class="desc" colspan="1">{{ $valores }} </td>
            <td class="desc" colspan="1"></td>
          </tr>
