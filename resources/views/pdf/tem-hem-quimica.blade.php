...
<style>
  ...
  <body>
    ...
    <div class="datos"><strong>Datos del Cliente<br><br></strong></div>
      ...
      <center><div style="font-size: 20px;"><strong>HEMOGRAMA Y QUIMICA</strong></div></center>
      ...
      <table border="0" cellspacing="0" cellpadding="0">   
        ...
        <tbody id="invoiceItems">
          ...
          <tr>
            ...
            <td class="desc">{{ $resChcm }}</td>
            <td class="unit">31   -   37 gr/dl</td>
            <td class="desc">{{ $obsChcm }}</td>
          </tr>
           <tr>
            <td class="unit">Plaquetas</td>
            <td class="desc">{{ $Plaquetas }}</td>
          ...
          <tr>
            ...
            <td class="desc"  style="border-top: 1px;">{{ $resbasofilico }}</td>
            <td class="unit"  style="border-top: 1px;">0% - 1%</td>
            <td class="desc"  style="border-top: 1px;">{{ $obsbasofilico }}</td>
          </tr>
          ...
          <tr>
            <td class="unit">Colesterol</td>
            <td class="desc"> {{ $resCOLESTEROL }}</td>
            <td class="unit">HASTA 200 mg/dl</td>
            <td class="desc">{{ $obsCOLESTEROL }}</td>
          </tr>
          <tr>
            <td class="unit">Trigliceridos</td>
            <td class="desc">{{ $resTRIGLICERIDOS }}</td> 
            <td class="unit">35 - 150 mg/dl</td>
            <td class="desc">{{ $obsTRIGLICERIDOS }}</td>
          </tr>
