      ...
      <table border="0" cellspacing="0" cellpadding="0">
        ...
        <thead>
          ...
          <tr>
            ...
            <td class="desc" colspan="2" >HEMATOCRITO - HEMOGLOBINA</th>
        ...
        <thead >
          ...
          <tr>
            ...
            <td class="desc" colspan="1">{{ $hemato }} </td>
            <td class="unit" colspan="1">{{ $vahemato }}</td>
          </tr>

          <tr>
            <td class="unit" >HEMOGLOBINA</td>
            <td class="desc" colspan="1">{{ $hemoglo }} </td>
            <td class="unit" colspan="1">{{ $vahemoglo }}</td>
          </tr>
