...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE QUIMICA </h1></center>
      </div>
    <br>

    <form action="/pdfquimica" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Glucosa (60 - 110  mg/dl)</strong>
              <input autocomplete="off" name="resglucosa" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>

            <div class="col">
              <strong>Observación de Glucosa</strong>
              <input autocomplete="off" name="obsglucosa" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        ...
        <div class="row">
             ...
             <div class="col">
              <strong>Resultado de Creatinina (0.6 - 0.8  mg/dl)</strong>
              <input autocomplete="off" name="rescreatinina" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
            <div class="col">
              <strong>Observación de Creatinina</strong>
              <input autocomplete="off" name="obscreatinina" type="text" class="form-control" style="border-color: #5FB5B5;">
            </div>        
        </div>

        <div class="row">
            <div class="col">
              <strong>Resultado de Nitrojeno Ureico (5 - 18 mg/dl)</strong>
              <input autocomplete="off" name="resureico" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
             <div class="col">
              <strong>Observación de Nitrojeno Ureico</strong>
              <input autocomplete="off" name="obsureico" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       
        </div>
       ...
       <!--  <div class="row">
            <div class="col">
              ...
              <input autocomplete="off" type="text" class="form-control  border border-primary"  aria-label="First name">
            </div>
            <div class="col">
              <strong>Apellido</strong>
              <input autocomplete="off" type="text" class="form-control  border border-primary" aria-label="Last name">
            </div>          
        </div> -->
