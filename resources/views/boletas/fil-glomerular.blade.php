...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE FILTRADO GLOMERULAR</h1></center>
      </div> 
    <br>

    <form action="/filglomerular" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="row">
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="2"> ml/min/m2 </textarea>
              <br>
            </div>                   
            ...
            <div class="col">
              ...
              HOMBRE 76 – 104 ml/min/m2
              MUJER 50 – 70 ml/min/m2
               </textarea>
              <br>
            </div>                               
        </div>
