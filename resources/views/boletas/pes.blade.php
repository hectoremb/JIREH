...
<head>
    ...
    <title>PRUEBA DE EMBARAZO EN SANGRE (PES) </title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE PRUEBA DE EMBARAZO EN SANGRE (PES)    </h1></center>
      </div>
    <br>

    <form action="/pes" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
