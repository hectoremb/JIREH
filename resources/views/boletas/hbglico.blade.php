...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE HEMOGLOBINA GLICOSILADA HBA1C</h1></center>
      </div>
    <br>

    <form action="/hb-glico" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            ...
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1">4.2 - 6.25 %   </textarea>
              <br>
            </div>    
        </div>
