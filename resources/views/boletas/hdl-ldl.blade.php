...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE HDL - LDL</h1></center>
      </div>
    <br>

    <form action="/hdl-ldl" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              <strong>COLESTEROL    HDL (45   -    65 mg/dl)</strong>
              <input autocomplete="off" name="reshdl" type="text" class="form-control"  style="border-color: #5FB5B5;" >
            </div>

            <div class="col">
              <strong>Observación de COLESTEROL    HDL </strong>
              <input autocomplete="off" name="obshdl" type="text" class="form-control"  style="border-color: #5FB5B5;" >
            </div>
        ...
        <div class="row">
             ...
             <div class="col">
              <strong>COLESTEROL    LDL (100  - 129.0    mg/dl)</strong>
              <input autocomplete="off" name="resldl" type="text" class="form-control"  style="border-color: #5FB5B5;"  >
            </div>
            <div class="col">
              <strong>Observación de COLESTEROL    LDL </strong>
              <input autocomplete="off" name="obsldl" type="text" class="form-control" style="border-color: #5FB5B5;">
            </div>        
        </div>

        <div class="row">
            <div class="col">
              <strong>TRANSAMINASA GOT (HASTA 40 U/L)</strong>
              <input autocomplete="off" name="resgot" type="text" class="form-control"  style="border-color: #5FB5B5;" >
            </div>
             <div class="col">
              <strong>OBSERVACION DE TRANSAMINASA GOT </strong>
              <input autocomplete="off" name="obsgot" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       
        </div>
        ...
        <div class="row">
            <div class="col">
              <strong>TRANSAMINASA GPT (HASTA 41 U/L)</strong>
              <input autocomplete="off" name="resgpt" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
             <div class="col">
              <strong>OBSERVACION DE  TRANSAMINASA GPT</strong>
              <input autocomplete="off" name="obsgpt" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       <br><br><br>
        </div>
      ...
      <div class="d-flex bd-highlight mb-3">
        ...
        <div class="ms-auto p-2 bd-highlight"><a href="/" class="btn btn-info" >Regresar</a></div><br><br><br>
      </div>
