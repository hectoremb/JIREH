...
<head>
    ...
    <title>TOXOPLASMA GONDII IgM - IgG </title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE TOXOPLASMA GONDII IgM - IgG</h1></center>
      </div>
    <br>

    <form action="/toxo" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="row">
            <div class="col">
              <strong>TOXOPLASMA GONDII IgM: </strong>
              
              <textarea autocomplete="off" name="igm" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="2"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE TOXOPLASMA GONDII IgM: </strong>
              
              <textarea autocomplete="off" name="valoresigm" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="2">
              NEGATIVO MENOR A 0.90                   
              POSITIVO MAYOR A  1.0       </textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="row">
            <div class="col">
              <strong>TOXOPLASMA GONDII IgG: </strong>
              
              <textarea autocomplete="off" name="igg" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="2"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE TOXOPLASMA GONDII IgG: </strong>
              
              <textarea autocomplete="off" name="valoresigg" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="2">
              NEGATIVO MENOR A 0.90                   
              POSITIVO MAYOR A  1.0       </textarea>
              <br>
