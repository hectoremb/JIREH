...
<head>
    ...
    <title>HEMATOCRITO - HEMOGLOBINA </title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE HT - HB <BR>(HEMATOCRITO - HEMOGLOBINA)</h1></center>
      </div>
    <br>

    <form action="/ht-hb" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="row">
            <div class="col">
              ...
              <textarea autocomplete="off" name="hemato" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE HEMATOCRITO: </strong>
              
              <textarea autocomplete="off" name="vahemato" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">42 – 51 %</textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="row">
            <div class="col">
              ...
              <textarea autocomplete="off" name="hemoglo" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE HEMOGLOBINA: </strong>
              
              <textarea autocomplete="off" name="vahemoglo" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">14.0 – 17.0 g/dL   </textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1">Sangre Completa </textarea>
              <br>
            </div>  
