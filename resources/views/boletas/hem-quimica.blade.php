...
<head>
    ...
    <title>HEMOGRAMA Y QUIMICA</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>HEMOGRAMA Y QUIMICA</h1></center>
      </div>
    <br>

    <form action="/pdf-hem-quimica" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Hematocrito (38 - 51%)</strong>
        ...
        <div class="row">
             ...
             <div class="col">
              <strong>Resultado de Hemoglobina (12.6  -  17.0 gr/dl)</strong>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Chcm:  (31   -   37 gr/dl)</strong>
              <input autocomplete="off" name="resChcm" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
             <div class="col">
              <strong>Observación de Chcm:</strong>
              <input autocomplete="off" name="obsChcm" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       
        </div>
        ...
        <div class="row">
            <div class="col">
              ...
              <input autocomplete="off" name="Plaquetas" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
            <div class="col">
              <strong>Observación de Plaquetas:</strong>
      ...
      <hr>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Neutrófilos:  (50  -  70 %)</strong>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Linfocitos:  (20     -    40 %)</strong>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de Eosinofilos:  (0       -     5   %)</strong>
        ...
        <div>
            <center><h2> <u>QUIMICA </u></h2></center>
        </div>

        <div class="row">
            <div class="col">
              <strong>Resultado de Colesterol:  (HASTA 200 mg/dl)</strong>
              <input autocomplete="off" name="resCOLESTEROL" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
             <div class="col">
              <strong>Observación de Colesterol:</strong>
              <input autocomplete="off" name="obsCOLESTEROL" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       
        </div>

        <div class="row">
            <div class="col">
              <strong>Resultado de Trigliceridos:  (35 - 150 mg/dl)</strong>
              <input autocomplete="off" name="resTRIGLICERIDOS" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
             <div class="col">
              <strong>Observación de Trigliceridos:</strong>
              <input autocomplete="off" name="obsTRIGLICERIDOS" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>       
        </div>
