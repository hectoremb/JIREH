...
<head>
    ...
    <title>UROCULTIVO POSITIVO INTERMEDIO</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA UROCULTIVO POSITIVO INTERMEDIO</h1></center>
      </div>
    <br>

    <form action="/uroposinter" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              ...
              <textarea autocomplete="off" name="res" type="text" class="form-control"  
        ...
        <div class="row">
             ...
             <div class="col">
              <strong>SENSIBLE A:</strong>
              <textarea  autocomplete="off" name="sensi" type="text" class="form-control"  style="border-color: #5FB5B5;"
              style="border-color: #5FB5B5;" rows="8"></textarea>
            </div>
            <div class="col">
              <strong>INTERMEDIO:</strong>
              <textarea autocomplete="off" name="inter" type="text" class="form-control" style="border-color: #5FB5B5;"
              style="border-color: #5FB5B5;" rows="8"></textarea>
            </div>     
            <div class="col">
              <strong>RESISTENTE:</strong>
              <textarea autocomplete="off" name="resis" type="text" class="form-control" style="border-color: #5FB5B5;"
              style="border-color: #5FB5B5;" rows="8"></textarea>
            </div>        
        </div>
