...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE HELICOBACTER PYLORI  IgM  (EN HECES)           
                                              
</h1></center>
      </div>
    <br>

    <form action="/pylorihec" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1">HECES</textarea>
              <br>
            </div>  
