...
<head>
    ...
    <title>UROCULTIVO NEGATIVO</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE UROCULTIVO NEGATIVO </h1></center>
      </div>
    <br>

    <form action="/uro-neg" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1">NEGATIVO A 48 HORAS DE INCUBACION A 37ºC</textarea>
              <br>
            </div>                   
        </div>
        ...
        <div class="row">
            <div class="col">
              <strong>Rercuento De Colonias: </strong>
              
              <textarea autocomplete="off" name="rcol" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"> UFC/ml de Orina</textarea>
              <br>
            </div>                   
        </div>
