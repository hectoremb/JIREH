...
<head>
    ...
    <title>EXAMEN GENERAL DE HECES</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>EXAMEN GENERAL DE HECES</h1></center>
      </div>
    <br>

    <form action="/heces" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            ...
            <div class="col">
              ...
              <input autocomplete="off" name="consistencia" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
                      
       
             <div class="col">
              <strong>Mucus: </strong>
              <input autocomplete="off" name="mucus" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        ...
        <div class="row">
            ...
            <div class="col">
             ...
             <div class="col">
              ...
              <input autocomplete="off" name="hematíes" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        ...
        <div class="row">
            <div class="col">
              <strong>Macroscópicos: </strong>
              <input autocomplete="off" name="macroscopicos" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>

            <div class="col">
              <strong>Microscópicos: </strong>
              <input autocomplete="off" name="microscopicos" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        ...
        <div class="row">
            <div class="col">
              ...
              <input autocomplete="off" name="activos" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>

            <div class="col">
              <strong>Resultado:</strong>
              <input autocomplete="off" name="quistes" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        </div><br><br>  
        ...
        <div class="row">
            <div class="col">
             <center><h3> <u>Metazoarios</u></h3></center>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
              ...
              <input autocomplete="off" name="Huevos" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>

            <div class="col">
              <strong>Larvas:</strong>
              <input autocomplete="off" name="Larvas" type="text" class="form-control"  style="border-color: #5FB5B5;">
            </div>
        </div><br><br>
