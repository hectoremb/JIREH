...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE VITAMINA D</h1></center>
      </div>
    <br>

    <form action="/vitaminad" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="6"></textarea>
              <br>
            </div>                   
            ...
            <div class="col">
              ...
              <textarea autocomplete="off" name="valores" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="6">
                DEFICIENCIA            10 - 20                    
                PROVISION SUBOPTIMA    20 - 30                   
                NIVEL OPTIMO           30 - 50                   
                SUPERIOR NORMAL        50 - 70                                      
                SOBREDOSIS NO TOXICA   70 - 150                   
                INTOXICACION        MAYOR A 150</textarea>
              <br>
            </div>    
