...
<head>
    ...
    <title>UROCULTIVO POSITIVO</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE UROCULTIVO POSITIVO </h1></center>
      </div>
    <br>

    <form action="/uro-pos" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="4"></textarea>
              <br>
            </div>                   
        </div>
        ...
        <div class="row">
             ...
             <div class="col">
              ...
              <textarea  autocomplete="off" name="sena" type="text" class="form-control"  style="border-color: #5FB5B5;"
              style="border-color: #5FB5B5;" rows="10"></textarea>
            </div>
            <div class="col">
              <strong>RESISTENTE A:</strong>
              <textarea autocomplete="off" name="resa" type="text" class="form-control" style="border-color: #5FB5B5;"
              style="border-color: #5FB5B5;" rows="10"></textarea>
            </div>        
        </div>
