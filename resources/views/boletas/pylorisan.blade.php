...
<head>
    ...
    <title>HELICOBACTER PYLORI  IgM </title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE HELICOBACTER PYLORI  IgM  (EN SANGRE)        
                                              
</h1></center>
      </div>
    <br>

    <form action="/pylorisan" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
