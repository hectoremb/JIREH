...
<head>
    ...
    <title>ANTIGENO PROSTATICO ESPECIFICO (PSA)</title>
...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE ANTIGENO PROSTATICO ESPECIFICO (PSA)</h1></center>
      </div>
    <br>

    <form action="/psa" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="row">
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1"> ng/ml</textarea>
              <br>
            </div>                   
            ...
            <div class="col">
              ...
              style="border-color: #5FB5B5;" rows="1">0.0 – 4.0 ng/ml</textarea>
              <br>
            </div>                               
        </div>
