...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE TIPEO SANGUÍNEO</h1></center>
      </div>
    <br>

    <form action="/tipo-san" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col">
              ...
              <textarea autocomplete="off" name="grupo" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
        </div>
