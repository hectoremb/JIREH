...
<body style="background: #58D9D9;">
    ...
    <br>
      <div>
        <center><h1>BOLETA DE TIROIDES</h1></center>
      </div>
    <br>

    <form action="/tiroides" method="post" style="margin-left: 5%; margin-right: 5%;">
        @csrf
        <div class="row">
            <div class="col">
      ...
      <br>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de T3: </strong>
              
              <textarea autocomplete="off" name="t3" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE T3: </strong>
              
              <textarea autocomplete="off" name="vat3" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">General   0.8 - 2.0 ng/ml</textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de T4: </strong>
              
              <textarea autocomplete="off" name="t4" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE T4: </strong>
              
              <textarea autocomplete="off" name="vat4" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">General   5.0  -  13.0 µg/dL   </textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="row">
            <div class="col">
              <strong>Resultado de TSH: </strong>
              
              <textarea autocomplete="off" name="tsh" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
       
            <div class="col">
              <strong>VALORES NORMALES DE TSH: </strong>
              
              <textarea autocomplete="off" name="vatsh" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">General   0.40 - 7.0  uIU/ml  </textarea>
              <br>
            </div>                               
        </div>
        ...
        <div class="col">
              ...
              <textarea autocomplete="off" name="muestra" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1">SUERO</textarea>
              <br>
            </div>  
            ...
            <div class="col">
              ...
              <textarea autocomplete="off" name="Observacion" type="text" class="form-control"  
              style="border-color: #5FB5B5;" rows="1"></textarea>
              <br>
            </div>                   
        </div>
